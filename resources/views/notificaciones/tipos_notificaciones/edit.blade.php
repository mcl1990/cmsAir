...
<div class="container-fluid">
	<ol class="breadcrumb breadcrumb-bg-black">
        ...
        <li><a href="/admin/tipo_notificacion"><i class="material-icons">assignment</i>Tipos de Notificaciones</a></li>
                	...
                	<form id="form_tipo_notificacion">
	                    ...
	                    <div class="row clearfix">
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            	...
                            	<textarea id="mensaje" name="mensaje" type="text" rows="4" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">{{ $tipo_notificacion->mensaje }}</textarea>
	                        </div>
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	<a href="/admin/tipos_notificaciones"><button  type="button" class="btn bg-grey waves-effect" data-toggle="tooltip" data-placement="top" title="Volver a la lista de tipo_notificacion">
