...
<div class="container-fluid">
	<ol class="breadcrumb breadcrumb-bg-black">
        ...
        <li><a href="/notificaciones"><i class="material-icons">assignment</i>Notificaciones</a></li>
                ...
                <div class="body">
                	<form id="form_notificaciones">
	                    ...
	                    <div class="row clearfix">
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	<a href="/notificaciones"><button  type="button" class="btn bg-grey waves-effect" data-toggle="tooltip" data-placement="top" title="Volver a la lista de notificaciones">
