                	...
                	<form id="form_usuarios">
                		<div class="row clearfix">
	                        ...
	                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input id="name" type="text" class="form-control" name="name" value="{{$usuario->name}}" placeholder="Nombre" required autofocus>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input id="email" type="email" class="form-control" name="email" value="{{$usuario->email}}" placeholder="Correo" required>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
	                    ...
	                    <div class="row clearfix">
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" id="id_perfil" hidden="hidden" value="{{ $usuario->perfil_id }}" >
                            </div>
