...
<div class="container-fluid">
	<ol class="breadcrumb breadcrumb-bg-black">
        ...
        <li class="active"><i class="material-icons">assignment</i>Bitácora Editores</li>
    </ol>
    <!-- Advanced Select -->
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Bitácora de acciones de usuario Editor
	...
	$(document).ready(function() {
		...
		$('#bitacora').on('click', 'a.delet', function (e) {
	        e.preventDefault();
	 		...
	 		var ruta = window.location.pathname;
	       	...
	       	// $.get('/bitacora_editor/' + id + '', function(data){ 
		...
		$.get('/consultas/get_perfil/', function(data){ 
			...
			var TableBitacora = $('#bitacora').DataTable({
		        ...
		        "processing": true,
		        "serverSide": true,
		        "ajax": "{{ route('datatable.bitacora_editor') }}",
		        "columns": [
