	                    ...
	                    <div class="row clearfix">
	                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input type="text" id="resolucion"  name="resolucion" class="form-control" maxlength="10" placeholder="Nombre del resolucion">
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input type="text" id="calidad"  name="calidad" class="form-control" maxlength="15" placeholder="Ej: HD">
	                                </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	...
	                        	<button  type="button" id="registrar" class="btn bg-black waves-effect" data-toggle="tooltip" data-placement="top" title="Registrar resolucion">
