            ...
            <div class="card">
                <div class="header">
                    <h2>
                        ...
                        <small>Actualizar de tamano (Unidad)</small>
                    </h2>
                </div>
                <div class="body">
	                    ...
	                    <div class="row clearfix">
	                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input type="text" id="tamano"  name="tamano" class="form-control" value="{{ $tamano->tamano }}" maxlength="5" placeholder="Ej: Gb">
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	...
	                        	<button  type="button" id="actulizar" class="btn bg-black waves-effect" data-toggle="tooltip" data-placement="top" title="Registrar tamano">
				                    <i class="material-icons">save</i>
				                    <span>Actualizar</span>
				                </button>
				                
                                
                                <input type="text" id="id" name="id" hidden="hidden" value="{{ $tamano->id }}" >
                            </div>
