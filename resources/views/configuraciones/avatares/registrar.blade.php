        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Registrar Avatar
                        <small>Registro de avatar (Descricpción)</small>
                    </h2>
                </div>
                <div class="body">

                	<form id="form_avatares" enctype="multipart/form-data">
	                    <div class="row clearfix">
	                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input type="text" id="avatar"  name="avatar" class="form-control" maxlength="20" placeholder="Nombre del avatar">
	                                </div>
	                            </div>
	                        </div>
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	...
	                        	<button  type="button" id="registrar" class="btn bg-black waves-effect" data-toggle="tooltip" data-placement="top" title="Registrar avatar">
