        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Actualizar Servidor
                        <small>Actualizar de servidor (Código y Nombre)</small>
                    </h2>
                </div>
                <div class="body">
                	<form id="form_servidores" >
	                    <div class="row clearfix">
	                    	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                    <input type="text" id="servidor"  name="servidor" class="form-control" value="{{ $servidor->servidor }}" maxlength="20" placeholder="Nombre del servidor">
	                                </div>
	                            </div>
	                        </div>
	                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
	                            ...
	                            <div class="form-group">
	                                <div class="form-line">
	                                	<img id="preview" width="15%" height="15%" src="../../images/iconos/{{ $servidor->icono }}" />
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                        	...
	                        	<button  type="button" id="actulizar" class="btn bg-black waves-effect" data-toggle="tooltip" data-placement="top" title="Registrar servidor">
				                    <i class="material-icons">save</i>
				                    <span>Actualizar</span>
				                </button>
				                
                                
                                <input type="text" id="id" name="id" hidden="hidden" value="{{ $servidor->id }}" >
                            </div>
